...
基于 hapipingye/simple-web-cicd 项目修改
作者：黄梓轩
学号：2440664303
"""
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .student-info { background: #e3f2fd; border-radius: 8px; padding: 12px;
                text-align: left; font-size: 13px; color: #1565c0; line-height: 1.6; margin-bottom: 16px; }
